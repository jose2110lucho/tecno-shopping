...
@section('content_header')
    <h1 style="text-align: center"><strong>Editar Categoria</strong></h1>
@stop
...
@section('content')
    ...
    <div class="card" style="background-color: beige">
        <div class="card-body" style="background-color: beige">
            <form action="{{route('categories.update',$categoriaId->id)}}" method="POST" id="formulario">
                @method('PUT')
                @csrf
                <div class="form-row">
                  <div class="form-group col-md-12">
                   ...
                   {{--  campo nombre --}}
                    ...
                    <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre de la categoria" required value="{{ $categoriaId->name }}">
                  </div>
